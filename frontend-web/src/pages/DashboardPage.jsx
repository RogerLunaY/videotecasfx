    ...
    return (
      <Layout>
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="bg-gradient-to-r from-primary-600 via-primary-500 to-salesiano-azul-500 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 text-white py-8">
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {/* Videos subidos */}
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow border-l-4 border-blue-500">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Videos Subidos</p>
                    <p className="text-4xl font-bold text-gray-900 dark:text-gray-100">{stats?.total_videos || 0}</p>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow border-l-4 border-yellow-500">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Visualizaciones</p>
                    <p className="text-4xl font-bold text-gray-900 dark:text-gray-100">{stats?.total_visualizaciones || 0}</p>
                  </div>
              ...
              {/* Espacio usado */}
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow border-l-4 border-purple-500">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Espacio Usado</p>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link
                  to="/perfil"
                  className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-primary-400 hover:shadow-lg transition-all group"
                >
                  <div className="flex items-center">
                    <div className="w-16 h-16 bg-primary-50 rounded-xl flex items-center justify-center mr-4 group-hover:bg-primary-100 dark:bg-primary-900/30 transition-colors">
                      <User className="w-8 h-8 text-primary-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-gray-900 dark:text-gray-100 mb-1">Mi Perfil</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Ver y editar información</p>
                    </div>
            ...
            <div>
              ...
              {videosLoading ? (
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-300 p-12 text-center">
                ...
                <div className="mt-8 flex justify-center">
                  <nav className="flex items-center space-x-2">
                    <button
                      ...
                      className="px-4 py-2 rounded-lg border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    >
                      Anterior
                    </button>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            {/* Total Docentes */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow border-l-4 border-green-500">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Docentes</p>
                  <p className="text-4xl font-bold text-gray-900 dark:text-gray-100">{stats?.total_docentes || 0}</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-1">Videos</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Catálogo completo</p>
                  </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-1">Usuarios</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Gestionar</p>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400" />
                </div>
              </Link>
                      ...
                      {stats.videos_populares.slice(0, 5).map((video, index) => (
                        <tr key={video.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <Link
                              to={`/videos/${video.id}`}
                              className="text-sm font-medium text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 flex items-center gap-2"
                            >
                  ...
                  <div className="space-y-6">
                    {stats.actividad_reciente.slice(0, 10).map((actividad, index) => (
                      <div key={index} className="relative pl-16">
                        {/* Punto del timeline */}
                        <div className="absolute left-0 w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center">
                          <Activity className="w-6 h-6 text-primary-600" />
                        </div>

                        {/* Contenido */}
                        <div className="bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-colors">
                          <p className="text-sm text-gray-900 dark:text-gray-100 font-medium mb-1">{actividad.descripcion}</p>
